...
export default function EstablishmentDashboard() {
  ...
  return (
    <div className="est-dashboard">
      {/* HEADER */}
      <div className="est-dashboard-header">
        {/* <div>
          <h2 className="est-dashboard-title">
            {establishment.nickname || 'Establishment'}
          </h2>
          <div className="est-dashboard-subtitle">
        ...
        <div className="est-dashboard-status-group">
          <span
            className={
              companyIsActive
      ...
      {/* GRID DE CARDS */}
      <div className="est-dashboard-grid">
